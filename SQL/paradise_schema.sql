...
CREATE TABLE `characters` (
  ...
  `ai_name` VARCHAR(55) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ai_core_display` VARCHAR(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Happy',
  `ai_hologram` VARCHAR(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default',
  `ai_hologram_color` VARCHAR(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#0099FF',
  `cyborg_name` VARCHAR(55) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
